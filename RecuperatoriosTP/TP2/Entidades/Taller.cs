...
namespace Entidades
{
    ...
    public sealed class Taller
    {
        ...
        /// </summary>
        /// <returns>devuelve un string con los datos del taller</returns>
        ...
        /// <returns>devuelve el taller con el elemento cargado</returns>
        ...
        /// <returns>devuelve el taller sin el elemento pasado por parametro</returns>
        public static Taller operator -(Taller t, Vehiculo vehiculo)
        {
            foreach (Vehiculo v in t.vehiculos)
            {
